...
let projects = [
  {
    image: 'textures/resume.jpeg',
    url: 'https://jarvasjdk.github.io/resume/',
  },
  {
    image: 'textures/bug-tracking.png',
    url: 'https://github.com/Jarvasjdk/Bug_Management_Tracker',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('NATHAN DAVIS', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
